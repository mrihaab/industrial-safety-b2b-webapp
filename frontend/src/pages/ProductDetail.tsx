...
export const ProductDetail: React.FC = () => {
  ...
  // Mock product detail state matching backend ProductDetailDto
  const product = {
    id: 1,
    slug: slug || 'gsh-elite-industrial-gloves',
    sku: 'GSH-WG-001',
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        {/* 2. PRODUCT INFORMATION & BULK ORDER BOX (5-Columns) */}
      ...
      {/* 3. SPECIFICATION MATRIX (2x2 Grid) */}

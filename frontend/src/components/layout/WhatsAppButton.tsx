...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-6 right-3 sm:right-6 z-40 flex items-center gap-3 group pointer-events-none pb-[env(safe-area-inset-bottom)]">
      ...
      <a
        ...
        className="pointer-events-auto relative bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center orange-glow-hover"
      >
